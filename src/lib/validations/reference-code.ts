...
export const referenceCodeCreateSchema = z.object({
  ...
  code_data2: z.string().optional(),
  code_data3: z.string().optional(),
  code_data4: z.string().optional(),
  code_data5: z.string().optional(),
  code_data6: z.string().optional(),
  code_data7: z.string().optional(),
  code_data8: z.string().optional(),
  code_data9: z.string().optional(),
