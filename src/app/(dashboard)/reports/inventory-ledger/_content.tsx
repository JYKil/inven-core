    ...
    <div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-background/50">
                  <TableHead className="sticky left-0 z-20 bg-background w-[100px] min-w-[100px]">품목코드</TableHead>
              ...
              <TableBody>
                {data.summary.map((s, idx) => (
                  <TableRow key={idx}>
                    <TableCell className="font-data sticky left-0 z-10 bg-card w-[100px] min-w-[100px]">{s.item_code}</TableCell>
                    <TableCell className="sticky left-[100px] z-10 bg-card min-w-[140px] shadow-[2px_0_5px_-2px_rgba(0,0,0,0.06)]">{s.item_name}</TableCell>
      ...
      <div className="border border-border rounded-[8px] overflow-x-auto">
        <Table>
          <TableHeader>
            <TableRow className="bg-background/50">
              <TableHead className="sticky left-0 z-20 bg-background w-[90px] min-w-[90px]">일자</TableHead>
              <TableHead className="sticky left-[90px] z-20 bg-background w-[100px] min-w-[100px]">품목코드</TableHead>
              <TableHead className="sticky left-[190px] z-20 bg-background min-w-[140px] shadow-[2px_0_5px_-2px_rgba(0,0,0,0.06)]">품목명</TableHead>
              <TableHead>창고</TableHead>
          ...
          <TableBody>
            {isLoading ? (
              ...
              data.transactions.map((tx, idx) => {
                ...
                return (
                  <TableRow key={idx}>
                    <TableCell className="font-data sticky left-0 z-10 bg-card w-[90px] min-w-[90px]">{formatDate(tx.transaction_date)}</TableCell>
                    <TableCell className="font-data sticky left-[90px] z-10 bg-card w-[100px] min-w-[100px]">{tx.item_code}</TableCell>
                    <TableCell className="sticky left-[190px] z-10 bg-card min-w-[140px] shadow-[2px_0_5px_-2px_rgba(0,0,0,0.06)]">{tx.item_name}</TableCell>
