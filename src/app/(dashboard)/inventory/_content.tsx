        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-background/50">
              ...
              <TableHead className={filters.view === 'item' ? 'sticky left-0 z-20 bg-background w-[100px] min-w-[100px]' : ''}>코드</TableHead>
              <TableHead className={filters.view === 'item' ? 'sticky left-[100px] z-20 bg-background min-w-[140px] shadow-[2px_0_5px_-2px_rgba(0,0,0,0.06)]' : ''}>품목명</TableHead>
              ...
              itemAggregated.length === 0 ? (
                ...
                itemAggregated.map((row: any) => {
                  ...
                  return (
                    ...
                    >
                      <TableCell className="font-data font-medium sticky left-0 z-10 bg-card w-[100px] min-w-[100px]">{row.code}</TableCell>
                      <TableCell className="font-medium sticky left-[100px] z-10 bg-card min-w-[140px] shadow-[2px_0_5px_-2px_rgba(0,0,0,0.06)]">{row.name}</TableCell>
