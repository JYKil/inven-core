...
export default function CustomersContent() {
  ...
  return (
    <div>
      <PageHeader title="고객정보">
        <Button render={<Link href="/customers/new" />} className="bg-primary hover:bg-primary-hover">
